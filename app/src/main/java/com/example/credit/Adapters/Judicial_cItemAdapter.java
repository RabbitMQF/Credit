...
public class Judicial_cItemAdapter extends BaseAdapter {
    private Context context;
    private List<String> list1;
    private List<String> list2;

    public Judicial_cItemAdapter(Context context, List<String> list1, List<String> list2) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        vh.cdc_tv1.setText(list2.get(position+1));
