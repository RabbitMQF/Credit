...
public class MyGridAdapter2 extends BaseAdapter {
	...
	public MyGridAdapter2(Context context, String[] array1, String[] array2 ) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.grid_item2, parent, false);
		}
		if(arrays1.length%2!=0){
		...
		TextView tv1 = BaseViewHolder.get(convertView, R.id.tv2_item1);
		TextView tv2 = BaseViewHolder.get(convertView, R.id.tv2_item2);
