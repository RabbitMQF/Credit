...
public class Support_CAdapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        vh.sitem_tv1C.setText(list.get(position).supportNum);
        vh.sitem_tv2C.setText(list.get(position).content);
        vh.sitem_tv3C.setText(list.get(position).department);
        vh.sitem_tv4C.setText(list.get(position).supportDate);
        return view;
    }
