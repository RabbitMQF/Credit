 ...
 * 
 */
public abstract class ZWFW_XZ_ManagerService {
	private String TAG = "ZWFW__ManagerService";
	 ...
	 */
	public void getZWFW_xzcf(final Context paramActivity, final int paramInt,final List<Map<String, Object>> list) {
		final String url = paramActivity.getResources().getString(
				com.WSZW.Activity.R.string.xzpoint);
		BaseAsyncTask loacl = new BaseAsyncTask(paramActivity, false) {
			...
			protected Integer doInBackground(Integer[] paramArrayOfInteger) {
				// TODO 自动生成的方法存根
				try {
					result=downloadDB( "xzcf", url,null);		
			...
			private void initListDatas() {
				...
				Constants.Zwfw_xzcf_listview_item=list_1;
			}
			@Override
			protected void onPostExecute(Integer paramInteger) {
				...
				ZWFW_XZ_ManagerService.this.handlerLoginInfo(paramActivity,
