...
public class GzLm_xqgk_cnnj_listveiw_adapter extends BaseAdapter {
	
	private Context context;
	private LayoutInflater inflater;
	private InfoFile_ infofile;
	List<GzLm_secondColumn_bean> list;
	public GzLm_xqgk_cnnj_listveiw_adapter(Context context,List<GzLm_secondColumn_bean> list) {
	...
	final int position1=position;	
		...
		public void onClick(View v) {
			infofile.chanIds().put(list.get(position1).getId().toString());
