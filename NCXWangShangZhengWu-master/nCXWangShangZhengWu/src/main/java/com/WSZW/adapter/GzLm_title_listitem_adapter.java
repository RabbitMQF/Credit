...
public class GzLm_title_listitem_adapter extends BaseAdapter {
	...
	public GzLm_title_listitem_adapter(Context context,List<GWLM_ZwDt_title> datas) {
...
//			viewholder.time.setText(datas.get(position).getCancelTopTime().subSequence(0, 10));  
	...
	final int position1=position;	
		...
		public void onClick(View v) {
			...
			infofile.gzlm_title().put(datas.get(position1).getTitle().toString());
...
//			infofile.gzlm_url().put(datas.get(position1).getUrl());
