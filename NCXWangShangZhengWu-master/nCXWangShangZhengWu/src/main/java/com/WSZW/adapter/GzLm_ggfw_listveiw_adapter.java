...
public class GzLm_ggfw_listveiw_adapter extends BaseAdapter {
	...
	public GzLm_ggfw_listveiw_adapter(Context context,List<GzLm_secondColumn_bean> list) {
	...
	final int position1=position;	
		...
		public void onClick(View v) {
			...
			intent.setClass(context, GZLM_Xxgk_list_Activity.class);
			context.startActivity(intent);
//			Intent intent=new Intent();
//			infofile.chanIds().put((866+position1)+"");
//			intent.setClass(context, GZLM_XqGk_list_Activity.class);
//			context.startActivity(intent);
		}
	});
			return convertView;
