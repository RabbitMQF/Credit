...
import com.WSZW.Activity.GZLM_LdZc_list_Activity;
import com.WSZW.Activity.R;
import com.WSZW.data.InfoFile_;
import com.WSZW.entity.GzLm_secondColumn_bean;

public class GzLm_ldzc_listveiw_adapter extends BaseAdapter {
	
	private Context context;
	private LayoutInflater inflater;
	private InfoFile_ infofile;
	List<GzLm_secondColumn_bean> list;
	public GzLm_ldzc_listveiw_adapter(Context context,List<GzLm_secondColumn_bean> list) {
	...
	final int position1=position;	
		...
		public void onClick(View v) {
					...
					intent.setClass(context, GZLM_LdZc_list_Activity.class);
