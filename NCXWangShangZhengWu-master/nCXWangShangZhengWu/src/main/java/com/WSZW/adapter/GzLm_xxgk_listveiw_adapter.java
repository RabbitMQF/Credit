...
public class GzLm_xxgk_listveiw_adapter extends BaseAdapter {
	
	private Context context;
	private LayoutInflater inflater;
	private InfoFile_ infofile;
	List<GzLm_secondColumn_bean> list;
	public GzLm_xxgk_listveiw_adapter(Context context,List<GzLm_secondColumn_bean> list) {
...
//				if(list.get(position1).getId().equals("752")){
