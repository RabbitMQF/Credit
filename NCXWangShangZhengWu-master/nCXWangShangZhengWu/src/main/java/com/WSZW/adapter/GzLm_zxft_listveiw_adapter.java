...
public class GzLm_zxft_listveiw_adapter extends BaseAdapter {
	...
	public GzLm_zxft_listveiw_adapter(Context context,List<GWLM_ZwDt_title> datas) {
	...
	viewholder.ll.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
            ...
            Uri content_url = Uri.parse((String) datas.get(position1).getUrl());   
