...
public class ZMHD_fragment_qt extends Fragment{
	...
	private void loadDatas(int nextpage) {
		// TODO 自动生成的方法存根
		pageIndex=nextpage+"";
		getQueryLetter.getQueryLetter(getActivity(), 1, "1219","7",pageIndex, "10");
	}
...
private boolean loadfinish = true; // 指示数据是否加载完成
	...
	public static ZMHD_fragment_qt newInstance(String string) {
		// TODO 自动生成的方法存根
		ZMHD_fragment_qt fragment = new ZMHD_fragment_qt();
		return fragment;
	}
}
