...
public class ZMHD_Fragment_ts extends Fragment{
	...
	private void loadDatas(int nextpage) {
		// TODO 自动生成的方法存根
		pageIndex=nextpage+"";
		getQueryLetter.getQueryLetter(getActivity(), 1, "1219","2",pageIndex, "10");
	}
...
private boolean loadfinish = true; // 指示数据是否加载完成
	...
	public static ZMHD_Fragment_ts newInstance(String string) {
		// TODO 自动生成的方法存根
		ZMHD_Fragment_ts newfragment = new ZMHD_Fragment_ts();
		return newfragment;
	}
}
