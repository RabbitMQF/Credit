...
public class ZMHD_fragment_qz extends Fragment{
	...
	private void loadDatas(int nextpage) {
		// TODO 自动生成的方法存根
		pageIndex=nextpage+"";
		getQueryLetter.getQueryLetter(getActivity(), 1, "1219","9",pageIndex, "10");
	}
...
private boolean loadfinish = true; // 指示数据是否加载完成
	...
	public static ZMHD_fragment_qz newInstance(String string) {
		// TODO 自动生成的方法存根
		ZMHD_fragment_qz newFragment_qz = new ZMHD_fragment_qz();
		return newFragment_qz;
	}
}
