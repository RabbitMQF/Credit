 ...
 *
 */
public class GZLM_Fragment_zcfg extends Fragment {
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getchannels.getChannels(getActivity(), 1, "getChannelsByParentId", endPoint, 3,774, 1);
		initView();
		return view;
	}
	...
	ChannelsByParentIdManagerService getchannels =new ChannelsByParentIdManagerService() {
		...
		protected void handlerLoginInfo(Context paramActivity,
			...
			adapter = new GzLm_zcfg_listveiw_adapter(getActivity(), list);
			lv.setAdapter(adapter);
		}
	};
	private GzLm_zcfg_listveiw_adapter adapter;
