 ...
 *
 */
public class GZLM_Fragment_shgles extends Fragment{
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		getchannels.getChannels(getActivity(), 1, "getChannelsByParentId", endPoint, 3, 793, 1);
		initView();
		return view;
	}
	...
	ChannelsByParentIdManagerService getchannels = new ChannelsByParentIdManagerService() {
		...
		protected void handlerLoginInfo(Context paramActivity,
			...
			adapter = new Gzlm_shgl_listview_adapter(getActivity(), list);
