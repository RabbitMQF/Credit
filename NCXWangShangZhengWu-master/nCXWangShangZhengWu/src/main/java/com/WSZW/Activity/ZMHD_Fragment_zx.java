...
public class ZMHD_Fragment_zx extends Fragment{
	...
	private void loadDatas(int nextpage) {
		// TODO 自动生成的方法存根
		pageIndex=nextpage+"";
		getQueryLetter.getQueryLetter(getActivity(), 1, "1219","1",pageIndex, "10");
	}
...
private boolean loadfinish = true; // 指示数据是否加载完成
	...
	public static ZMHD_Fragment_zx newInstance(String string) {
		// TODO 自动生成的方法存根
		ZMHD_Fragment_zx newfragment = new ZMHD_Fragment_zx();
		return newfragment;
	}
}
